  ...
  return (
    <div className="p-6">
      <AdminPageHeader
        ...
        actions={
          <>
            <Button variant="outline" onClick={handleExport} disabled={exportando} className="border-[var(--admin-accent)] text-[var(--admin-muted-foreground)] hover:border-[var(--admin-accent)] hover:text-stone-900 hover:bg-[var(--admin-warning-soft)]">
