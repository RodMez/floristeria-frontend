...
export default function SedeCard({ sede, variant = "navigable" }: SedeCardProps) {
  ...
  return (
    <div
      ...
      className={isNavigable ? "cursor-pointer h-full w-full" : "h-full"}
    >
      <Card className="group border-t-4 border-b-4 border-t-brand-rose border-b-brand-rose hover:border-t-brand-mustard hover:border-b-brand-mustard transition-all duration-300 hover:-translate-y-2 hover:scale-[1.02] hover:shadow-2xl shadow-md h-full">
