...
export default function SedeCard({ sede, variant = "navigable" }: SedeCardProps) {
  ...
  return (
    ...
    >
      <Card className="group border-t-4 border-b-4 border-t-brand-rose border-b-brand-rose hover:border-t-brand-mustard hover:border-b-brand-mustard transition-all duration-300 hover:-translate-y-1 hover:shadow-xl shadow-md h-full">
